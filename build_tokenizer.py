...
tokenizer = CamembertTokenizer(vocab_file=input_tokenizer_path, max_len=512)
...
# user_defined_symbols : permet de donner une liste d'éléments qui ne seront pas découpé
